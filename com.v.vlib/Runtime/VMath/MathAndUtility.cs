...
namespace V
{
    ...
    public static class GaussianDist
    {
        ...
        public static double GetRandomNumber(float mean, float stdDev)
        {
            ...
            double randStdNormal = System.Math.Sqrt(-2.0 * System.Math.Log(u1)) * System.Math.Sin(2.0 * Mathf.PI * u2); //random normal(0,1)
        ...
        {
            double exponent = -1 * (0.5 * System.Math.Pow(std, -2) * System.Math.Pow(x - u, 2));
            double numerator = System.Math.Pow(System.Math.E, exponent);
            double denominator = System.Math.Sqrt(2 * System.Math.PI * System.Math.Pow(std, 2));
            return numerator / denominator;
        }

        public static double StandardNormalPdf(double x)
        {
            double exponent = -1 * (0.5 * System.Math.Pow(x, 2));
            double numerator = System.Math.Pow(System.Math.E, exponent);
            double denominator = System.Math.Sqrt(2 * System.Math.PI);
            return numerator / denominator;
        }
